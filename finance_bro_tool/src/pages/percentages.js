...
function Percentages() {
  ...
  async function fetchAdd(info){
   ...
   function handleSubmit(e) {
    ...
    if (total !== 100) {
      alert("The total of needs, savings, and wants must add up to 100%");
      return;
    }
  ...
  return (
   ...
   <Grid />
    <button type="submit" className="bg-secondary font-black  mt-6 w-1/3 rounded-r-3xl  h-12 text-white ">Complete</button>
    </div>
    </form>
